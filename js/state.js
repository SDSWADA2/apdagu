...
const INITIAL_STATE = {
  profil_sekolah: {
    ...
    akreditasi: 'A (Unggul)',
    alamat_lengkap: 'Jl. Pendidikan No. 45 Desa Sumber Waru',
    ...
    kode_pos: '67291',
    telepon: '(0335) 841234',
    email: 'sdnsumberwaru2@kemdikbud.go.id',
    website: 'https://sdnsumberwaru2.sch.id',
    nama_kepala_sekolah: 'Drs. H. Bambang Sutrisno, M.Pd.',
    nip_kepala_sekolah: '196805121992031004',
    stempel_url: '',
    logo_url: ''
  },
